...
export async function optimizedRefsReq({ url, addRef, }) {
...
export async function optimizedRefsRes({ origUrl, resBody, statusCode, resHeaders, }) {
    ...
    if (statusCode !== 200) {
        ...
        const capabilites = "\x00multi_ack thin-pack side-band side-band-64k ofs-delta shallow deepen-since deepen-not deepen-relative no-progress include-tag multi_ack_detailed allow-tip-sha1-in-want allow-reachable-sha1-in-want no-done filter object-format=sha1";
